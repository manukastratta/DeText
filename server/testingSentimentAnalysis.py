...
print(example_slightly_negative.sentiment)  # 0.15
print(example_slightly_negative2.sentiment)  # 0.175
print(example.sentiment)  # 0.1
print(example_explicit.sentiment)  # neu